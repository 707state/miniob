...
#define DEFINE_ENUM()                  \
  ...
  DEFINE_ENUM_ITEM(ALTER_INDEX_ADD)    \
  DEFINE_ENUM_ITEM(ALTER_INDEX_DROP)   \
  DEFINE_ENUM_ITEM(ALTER_INDEX_MODIFY) \
  DEFINE_ENUM_ITEM(ALTER_COLUMN_ADD)   \
  DEFINE_ENUM_ITEM(ALTER_COLUMN_DROP)  \
  DEFINE_ENUM_ITEM(ALTER_COLUMN_MODIFY)
