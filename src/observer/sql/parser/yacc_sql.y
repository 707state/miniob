...
//%type <sql_node>            alter_table_modify_stmt
...
action:
    ...
    MODIFY INDEX ID LBRACE ID RBRACE{
    $$=new ParsedSqlNode(SCF_ACTION);
    ActionSqlNode &action=$$->action;
    action.attribute_name=$5;
    action.index_name=$3;
...
drop_table_stmt:    /*drop table 语句的语法解析树*/
    DROP TABLE ID {
      ...
      DropTableSqlNode &drop_table=$$->drop_table;
